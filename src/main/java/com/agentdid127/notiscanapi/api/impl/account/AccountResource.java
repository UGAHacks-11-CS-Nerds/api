...
public class AccountResource {
     ...
     */
    public AccountResource(long id, String username, String email, String salt, String hash) {
        this.id = id;
     ...
     */
    public AccountResource(String username, String email) {
...
//    }
     ...
     * @param password
     */
    public void createLogin(String username, String email, String password) {
        this.email = email;
        this.username = username;
...
//    void insertAccount() {
//        NotiscanApiApplication.DATABASE.insert("");
//    }
